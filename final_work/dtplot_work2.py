...
def plot(TDGRatMG_work2_1,TDMG_work2_1,TDGRatMG_work2_2,TDMG_work2_2,TDGRatMG_work2_3,TDMG_work2_3,TDGRatMG_work2_4,TDMG_work2_4):
   ...
   # plt.axvline(0.412,ls='dotted',color='#FF8000', linewidth=0.5)
    ...
    plt.plot(TDGRatMG_work2_1[0:701,0],100.0*(TDMG_work2_1[0:701,1]-TDGRatMG_work2_1[0:701,1])/TDGRatMG_work2_1[0:701,1],color='deeppink',linewidth=2,label=r'$r_{01}=10~\texttt{kpc},\frac{\delta\Sigma}{\Sigma}=12\%$')
    ...
    plt.plot(TDGRatMG_work2_2[652,0],100.0*(TDMG_work2_2[652,1]-TDGRatMG_work2_2[652,1])/TDGRatMG_work2_2[652,1],'r*')
    ...
    plt.plot(TDGRatMG_work2_3[1069,0],100.0*(TDMG_work2_3[1069,1]-TDGRatMG_work2_3[1069,1])/TDGRatMG_work2_3[1069,1],'r*')
    ...
    plt.plot(TDGRatMG_work2_4[817,0],100.0*(TDMG_work2_4[817,1]-TDGRatMG_work2_4[817,1])/TDGRatMG_work2_4[817,1],'r*', label='SIS broken')
